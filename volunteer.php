    ...
    <div class="form">
      <div class="d-flex">
        ...
        <div class="volunteer mt-2">
          <a href="contact.php" class="btn">Send Email</a>
        </div>
      </div>
      ...
      <form id="submit-form" action="">
        ...
        <p class="full-width">
          <input id="age" class="form-input" type="text" placeholder="Your Age*" required>
          <small></small>
        </p>
        <p class="full-width">
          <textarea  minlength="20" id="address" cols="30" rows="7" placeholder="Address*" required></textarea>
          <small></small>
        </p>
        <p class="full-width">
          <textarea  minlength="20" id="message" cols="30" rows="7" placeholder="Message*" required></textarea>
          <small></small>
        </p>
        <p class="full-width">
